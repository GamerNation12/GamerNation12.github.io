  ...
  <div id="container">
    ...
    <div class="center">
      ...
      <div class="panel discordPanel">
        ...
        <a id="avatarLink" target="_blank" href="gamernation12.github.io/GamerNation12/"><img class="discordAvatar" id="discordAvatar" src="images/template-transparent.png"></a>
        <p class="discordName" id="discordName"></p>
        <p class="discordMotd" id="discordMotd"></p>
        <ul class="social-icons list-unstyled list-inline">
          <li><a target="&rdquo;_blank&rdquo;" href="https://www.youtube.com/c/MinecraftGamerNation0"><i class="fa-brands fa-youtube" style="color: #ff0000;"></i></a></li>
          <li><a target="&rdquo;_blank&rdquo;" href="https://rblx.name/3380857326"><i class="fa-solid fa-gamepad fa-lg" style="color: #ffffff;"></i></a>
          </li>
          <li><a target="&rdquo;_blank&rdquo;" href="mailto:Minecraft-Gamer-Nation@post.com%0A"><i class="fa-solid fa-envelope fa-xl" style="color: #ffffff;"></i></a>
          </li>
        </ul>
      </div>
      <div class="gap"></div>
      <div class="panel spotifyPanel">
        ...
        <a id="trackLink" target="_blank" href="gamernation12.github.io/GamerNation12/"><img class="trackImg" id="trackImg" src="images/music.png"></a>
      ...
      <div id="rpcPanel" class="panel rpcPanel">
        ...
        <img class="rpcIcon" id="rpcIcon" src="images/game.png">
